...
pipeline (there's no chart). Judge them on diligence and structure instead.
...
Treat as a **speculative, illiquid bucket** outside the public sleeves. Size so a total loss is
survivable; never fund it from money earmarked for the tradable account.
